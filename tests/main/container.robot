...
Ignore Containers Marked With A Specific Label
    ...
    ...    text=sudo -E tedge-container engine docker run -d --label tedge.ignore=1 --network bridge --name manualapp10 ghcr.io/thin-edge/test-images/alpine:latest sleep infinity
